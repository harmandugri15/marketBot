...
STOCK_UNIVERSE = [
    ...
    "NTPC", "TMCV", "TMPV", "ADANIPORTS", "ULTRACEMCO", "ASIANPAINT", "COALINDIA", "BAJAJFINSV", "BPCL", "M&M", "JSWSTEEL",
    ...
    "LTM", "VBL", "TATACONSUM", "SHREECEM", "JIOFIN", "JSWENERGY", "INDIGO", "ETERNAL", "CHOLAFIN", "DRREDDY",
    ...
    "NYKAA", "PAYTM", "POLICYBZR", "DELHIVERY", "ETERNAL", "CARTRADE", "MAPMYIND", "RATEGAIN", "NAUKRI",
