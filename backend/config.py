...
NIFTY_IT = ['COFORGE.NS', 'HCLTECH.NS', 'INFY.NS', 'LTIM.NS', 'MPHASIS.NS', 'PERSISTENT.NS', 'TCS.NS', 'TECHM.NS', 'WIPRO.NS']

def resolve_universe(universe: str) -> list[str]:
    u = universe.upper()
    if u == 'NIFTY_50': return NIFTY_50
    if u == 'NIFTY_BANK': return NIFTY_BANK
    if u == 'NIFTY_IT': return NIFTY_IT
